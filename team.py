...
metadata = {
    ...
    "team_name": f"StudentReps", 

    # Fill in the student IDs and emails of both team members here. There must
    # be exactly two members in the list. 
    "team_members": [
        {
            "name": "Matthew James Cheung",
            "student_id": "1461802",
            "email": "mjcheung@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Lenni Migios",
            "student_id": "1461288",
            "email": "lmigios@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
